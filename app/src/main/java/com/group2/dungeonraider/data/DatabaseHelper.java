...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_MUTATOR = "CREATE TABLE "
            ...
            + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_MUTATOR_NAME + " TEXT NOT NULL UNIQUE ,"
            + KEY_MUTATOR_VALUE + " INTEGER" + KEY_MUTATOR_COLOR + " TEXT NOT NULL UNIQUE);";
    ...
    private static final String CREATE_TABLE_ROOM = "CREATE TABLE "
            ...
            + KEY_PUZZLE_STRUCT + " TEXT NOT NULL,"
            + KEY_LEVEL_ID + " INTEGER NOT NULL, FOREIGN KEY("
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        values.put(KEY_ITEM_NAME, Constants.ITEM_POTION);
        values.put(KEY_PURCHASE_VALUE, Constants.ITEM_POTION_VALUE);
        db.insert(TABLE_ITEMS, null, values);

        values.put(KEY_ITEM_NAME, Constants.ITEM_BOMB);
        values.put(KEY_PURCHASE_VALUE, Constants.ITEM_BOMB_VALUE);
        db.insert(TABLE_ITEMS, null, values);


        values.put(KEY_ITEM_NAME, Constants.ITEM_MAP);
        values.put(KEY_PURCHASE_VALUE, Constants.ITEM_MAP_VALUE);
        db.insert(TABLE_ITEMS, null, values);


        values.put(KEY_ITEM_NAME, Constants.ITEM_KEY);
        values.put(KEY_PURCHASE_VALUE, Constants.ITEM_KEY_VALUE);
        db.insert(TABLE_ITEMS, null, values);
    ...
    public long addItem(Item item) {
        ...
        values.put(KEY_PURCHASE_VALUE, item.getValue());
