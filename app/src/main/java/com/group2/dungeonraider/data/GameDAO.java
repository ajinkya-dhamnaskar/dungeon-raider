...
public class GameDAO extends SQLiteOpenHelper
{
	...
	private static final String[] POPULATE_TABLE_GAME_LEVEL_TILES = {
		...
		/* 5  */+ "01,00,00,00,07,00,00,00,00,00,00,00,07,01,01" + GameLevelTileData.TILE_DATA_LINE_BREAK
		/* 6  */+ "01,00,07,00,07,00,00,07,00,00,00,00,00,01,01" + GameLevelTileData.TILE_DATA_LINE_BREAK
		/* 7  */+ "01,00,01,11,01,11,07,11,01,00,00,00,00,01,01" + GameLevelTileData.TILE_DATA_LINE_BREAK
		...
		/* 12 */+ "01,00,07,00,00,00,07,01,02,07,07,00,01,01,01" + GameLevelTileData.TILE_DATA_LINE_BREAK
